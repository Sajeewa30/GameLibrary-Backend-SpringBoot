...
public class OpenAiClientService {
    ...
    private static final String SYSTEM_PROMPT = "You are a video game historian. Only include games released in the specified year. Exclude Nintendo-only and mobile-only games. Prefer PC/PlayStation/Xbox releases. Return only valid JSON. No extra text.";
